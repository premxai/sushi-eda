...
> = {
  csv: {
    bg: "rgba(144,96,248,0.12)",
    color: "#7a40e8",
    gradient: "linear-gradient(135deg,#9060f8,#7c4ddb)",
  },
  xlsx: {
    bg: "rgba(64,128,255,0.12)",
    color: "#3060e0",
    gradient: "linear-gradient(135deg,#4080ff,#3060cc)",
  },
  xls: {
    bg: "rgba(64,128,255,0.12)",
    color: "#3060e0",
  ...
  json: {
    ...
    color: "#c88010",
    gradient: "linear-gradient(135deg,#e8a020,#c88010)",
  },
  parquet: {
    bg: "rgba(232,64,200,0.12)",
    color: "#c030a8",
    gradient: "linear-gradient(135deg,#e840c8,#c030a8)",
  },
  tsv: {
    bg: "rgba(0,212,232,0.12)",
    color: "#00a0b8",
    gradient: "linear-gradient(135deg,#00d4e8,#00a0b8)",
  },
  sqlite: {
    bg: "rgba(32,192,96,0.12)",
    color: "#189050",
    gradient: "linear-gradient(135deg,#20c060,#189050)",
  },
  db: {
    bg: "rgba(32,192,96,0.12)",
    color: "#189050",
  ...
  return (
    <button
      ...
      style={{
        ...
        border: hov
          ? "1px solid rgba(144,96,248,0.28)"
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: 11, color: "#b8b4ae", marginLeft: "auto" }}>
      ...
      {tab === "upload" && (
        <>
            ...
            {isUploading && selectedFile ? (
              <div style={{ width: "100%", maxWidth: 340 }}>
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 13, fontWeight: 500, color: "#111010" }}
                  >
                    {selectedFile.name}
                  </span>
                  <span style={{ fontSize: 11, color: "#9a9690" }}>
              ...
              <div style={{ textAlign: "center" }}>
                <AlertCircle
                  size={26}
                  style={{ color: "#e85454", margin: "0 auto 8px" }}
                />
                <p style={{ fontSize: 14, fontWeight: 500, color: "#e85454" }}>
                  Upload failed
                </p>
          ...
          {!isUploading && !selectedFile && (
            ...
            >
              or try{" "}
              <span style={{ color: "#9060f8", fontWeight: 500 }}>
                &ldquo;Sales Data&rdquo;
              </span>{" "}
              sample
            </button>
          )}
              ...
              {datasets.map((ds) => {
                ...
                return (
                  ...
                  >
                    ...
                    <ArrowRight
                      size={13}
                      style={{ color: "#c8c4be", flexShrink: 0 }}
                    />
                  </button>
                );
              })}
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: 13, fontWeight: 600, color: "#111010" }}>
              Getting started
            </div>
          ...
          {GETTING_STARTED_STEPS.map((s, i) => (
            ...
            >
              ...
              <span
                style={{
                  fontSize: 12,
                  color: s.done ? "#888580" : "#1a1a1a",
                  textDecoration: s.done ? "line-through" : "none",
                  fontWeight: s.done ? 300 : 400,
                }}
              >
                {s.label}
              </span>
...
export function UserDashboard(props: UserDashboardProps) {
  ...
  const thisWeek = datasets.filter(
        ...
        >
          ...
          <div
            style={{
              ...
              height: 2,
              background:
                "linear-gradient(90deg,transparent,rgba(144,96,248,0.5),rgba(232,64,200,0.5),transparent)",
            }}
          />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <button
              onClick={() =>
                notify("Export available after uploading a dataset")
              }
              style={{
                display: "flex",
                alignItems: "center",
            ...
            <div>
              ...
              {loading ? (
                ...
                >
                  <FileSpreadsheet
                    size={28}
                    style={{ color: "#c8c4be", margin: "0 auto 12px" }}
                  />
                  <p
                  ...
                  {datasets.slice(0, 4).map((ds) => {
                    ...
                    return (
                      <button
                        key={ds.id}
                        onClick={() =>
                          handleDatasetClick(ds.id, ds.original_filename)
                        }
                        style={{
                          display: "flex",
                          alignItems: "center",
              ...
              >
                {[
                  {
                    icon: <Database size={13} style={{ color: "#9060f8" }} />,
                    val: datasets.length,
                    label: "Total Datasets",
                  },
                  {
                    icon: <TrendingUp size={13} style={{ color: "#00d4e8" }} />,
                    val: thisWeek,
                    label: "This Week",
                  },
                  {
                    icon: <Layers size={13} style={{ color: "#e840c8" }} />,
                    val: formatRowsShort(totalRows),
                    label: "Total Rows",
                  },
                  {
                    icon: <Star size={13} style={{ color: "#e8a020" }} />,
                    val: starred,
                    label: "Starred",
                  },
                ].map((s, i) => (
              ...
              >
                {[
                  ...
                  },
                  {
                    label: "Total Columns",
                    val: datasets
                      .reduce((s, d) => s + (d.column_count ?? 0), 0)
                      .toString(),
                    color: "#e840c8",
                  },
                  {
                    label: "Total Data Volume",
                    val: formatBytes(totalSize),
                    color: "#00d4e8",
                  },
                  {
                    label: "Datasets This Week",
                    val: thisWeek.toString(),
                    color: "#20c060",
                  },
                ].map((m) => (
                  <div
                  ...
                  >
                    {fmtEntries.map(([ext, count]) => (
                      <div
                        key={ext}
                        style={{
                          width: `${(count / datasets.length) * 100}%`,
                          background: FORMAT_COLORS[ext]?.color || "#9060f8",
                        }}
                      />
                    ))}
                  </div>
                    ...
                    {fmtEntries.map(([ext, count]) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {count} (
                            {Math.round((count / datasets.length) * 100)}%)
                          </span>
                        </div>
                      );
                    })}
