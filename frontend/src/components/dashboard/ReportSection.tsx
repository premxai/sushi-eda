...
function generateMarkdown(report: EDAReport, fileName: string): string {
...
export function ReportSection({ report, fileName = "dataset" }: Props) {
  ...
  function exportMarkdown() {
    const md = generateMarkdown(report, fileName);
