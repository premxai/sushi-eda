...
const SECTIONS = [
  ...
  },
  {
    title: "Ask Your Data",
    body: [
      "Type a question in plain English, like \"what's the average order value?\" or \"which region has the most cancellations?\", and get an answer in plain English back.",
