    ...
    <Plot
      data={[
        ...
        } as Plotly.Data,
        {
          ...
          type: "scatter",
          mode: "lines",
          line: { color: "#C23B2E", width: 1.5, dash: "dash" },
        ...
        },
        {
          ...
          type: "scatter",
          mode: "lines",
          line: { color: "#6E8F2E", width: 1.5, dash: "dash" },
      ...
      layout={{
        ...
        legend: {
          ...
          xanchor: "right",
          y: 1,
          font: { size: 10, color: "var(--muted-ink)" },
          bgcolor: "transparent",
        },
        xaxis: {
          title: { text: columnName, font: { size: 11, color: "var(--faint-ink)" } },
          gridcolor: "var(--line)",
